...
open class OpenAPSSMBPlugin @Inject constructor(
    ...
    override fun preprocessPreferences(preferenceFragment: PreferenceFragmentCompat) {
        ...
        preferenceFragment.findPreference<SwitchPreference>(BooleanKey.ApsUseSmbWithCob.key)?.isVisible = smbEnabled && !smbAlwaysEnabled
        preferenceFragment.findPreference<SwitchPreference>(BooleanKey.ApsUseSmbWithLowTt.key)?.isVisible = smbEnabled && !smbAlwaysEnabled
